/**
 * LucideIconName — union of every icon name available in @lucide/angular v1.11.0.
 *
 * Source: lucide.dev/icons  (1 701 icons, auto-generated — do not edit by hand).
 *
 * Usage with ios-icon:
 *   <ios-icon name="award" class="w-5 h-5 text-ios-brand-primary" />
 *
 * To add new icons to a component / page use provideIcons():
 *   providers: [provideIcons(LucideAward, LucideCalendar)]
 */
