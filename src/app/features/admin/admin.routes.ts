...
export const ADMIN_ROUTES: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'staff',
        loadComponent: () => import('./pages/admin-staff.page').then((m) => m.AdminStaffPage),
        title: () => inject(LanguageService).t('admin.staff.title'),
      },
      {
        path: 'promo-codes',
        loadComponent: () =>
          import('./pages/admin-promo-codes.page').then((m) => m.AdminPromoCodesPage),
        title: () => inject(LanguageService).t('admin.promo.title'),
      },
      {
        path: 'blog',
        loadComponent: () => import('./pages/admin-blog.page').then((m) => m.AdminBlogPage),
        title: () => inject(LanguageService).t('admin.blog.title'),
      },
      {
        path: 'contact',
        loadComponent: () => import('./pages/admin-contact.page').then((m) => m.AdminContactPage),
