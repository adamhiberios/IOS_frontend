...
@Component({
  ...
  template: `
    <div class="min-h-screen flex flex-col">
      ...
      <section class="relative flex-1 px-10 md:px-32 lg:px-46 py-18 lg:py-[72px] bg-white">
        ...
        <div
          class="relative max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-10 lg:gap-16 items-start justify-between"
        >
            ...
            <div class="flex flex-col gap-1">
              ...
              @if (nameError(); as error) {
                <p
                  ...
                  class="text-ios-danger text-[13px] leading-[1.4]"
                  aria-live="polite"
                >
                  {{ error }}
                </p>
  ...
  protected onSubmit(): void {
    ...
    this.contactApi
      ...
      .subscribe({
        ...
        error: (err: unknown) => {
          this.submitting.set(false);
          this.errorMessage.set(problemDetailMessage(err) ?? this.lang.t('contact.form.error'));
        },
      });
  }
}
