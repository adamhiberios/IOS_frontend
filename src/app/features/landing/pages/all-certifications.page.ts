...
@Component({
  ...
  template: `
    ...
    ═══════════════════════════════════════════════════════════ -->
    <section class="bg-ios-surface-warm py-[72px]" aria-labelledby="all-certs-intro-heading">
        ...
        <div class="flex flex-col items-center gap-5 text-center mx-auto max-w-[1236px]">
          ...
          >
            ...
            <span class="text-ios-brand-primary">{{
              lang.t('allCertifications.intro.headingPart2')
            }}</span>
          </h2>

          <!-- Description -->
          <p class="font-body font-medium text-[15px] md:text-[16px] leading-[1.6] text-ios-fg-8">
            {{ lang.t('allCertifications.intro.description') }}
          </p>

          <!-- Gold bar -->
          <div class="h-[4px] w-[180px] rounded-full bg-ios-brand-gold" aria-hidden="true"></div>
        </div>
    ...
    >
      <div
        class="w-full max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[120px] flex flex-col items-center gap-[24px]"
      >
        <!-- Centered heading block -->
        <div class="flex flex-col items-center gap-4 text-center">
          <h2
            id="all-certs-sm-heading"
          ...
          <p class="font-body font-medium text-[16px] leading-[1.6] max-w-[560px] text-ios-fg-8">
            {{ lang.t('allCertifications.tracks.scrumMaster.description') }}
          </p>
          <div class="h-[4px] w-[274px] rounded-full bg-ios-brand-gold" aria-hidden="true"></div>
        </div>
        ...
        <div class="flex flex-col xl:flex-row gap-[24px] items-stretch w-full justify-center">
          @for (cert of smCerts; track cert.code) {
            <ios-certification-card
              ...
              [enrollLabel]="lang.t('allCertifications.shared.moreDetails')"
    ...
    ═══════════════════════════════════════════════════════════ -->
    <section class="bg-white" aria-labelledby="all-certs-comparison-heading">
      <div
        class="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 xl:px-[246px] py-[72px] flex flex-col gap-8"
      >
        <!-- Section header -->
    ...
    ═══════════════════════════════════════════════════════════ -->
    <section class="bg-ios-surface-warm" aria-labelledby="all-certs-faq-heading">
      <div
        class="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 xl:px-[246px] py-[72px] flex flex-col gap-8"
      >
        <!-- Section header -->
        <div class="flex flex-col items-center text-center gap-4">
          ...
          >
            ...
            <span class="text-ios-brand-primary">{{
              lang.t('allCertifications.faq.headingPart2')
            }}</span>
          </h2>
